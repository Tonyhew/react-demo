(function (global, factory) {
  ...
  */
  ...
  var styles = {"emptyWrapper":"index-module_emptyWrapper__3JdvZ","tagContainer":"index-module_tagContainer__3_88c","cardContainer":"index-module_cardContainer__1_4Jf","templateCard":"index-module_templateCard__1S0F4","demo":"index-module_demo__1SorJ","addProject":"index-module_addProject__2MGLz","previewBtn":"index-module_previewBtn__1Wgo1","addBtn":"index-module_addBtn__3NxRn","col":"index-module_col__1CLyM","img":"index-module_img__NuOV9","defaultImg":"index-module_defaultImg__16U5p","spin":"index-module_spin__2cr4I","content":"index-module_content__1PZ-A","title":"index-module_title__3AO2Z","description":"index-module_description__R6Hxn","meats":"index-module_meats__2PEHX","tags":"index-module_tags__28KUd","tagItem":"index-module_tagItem__6yXXH","tagInCard":"index-module_tagInCard__2Weul","info":"index-module_info__9MO2B"};
  styleInject(css);

  var css$1 = ".index-module_tagContainer__3YNKY {\n  margin-bottom: 16px;\n  float: right;\n  margin-right: -8px;\n  max-width: 50vw;\n  margin-top: 0;\n  text-align: right;\n  position: relative;\n  display: -webkit-box;\n  display: flex;\n}\n.index-module_tagContainer__3YNKY .ant-tag:not(.ant-tag-checkable-checked) {\n  border: 1px solid rgba(255, 255, 255, 0.15);\n  text-align: center;\n}\n.index-module_tagContainer__3YNKY .ant-tag-checkable-checked {\n  background-color: #1890ff;\n}\n.index-module_tagContainer__3YNKY .ant-tag {\n  -webkit-box-flex: 1;\n          flex: auto;\n  margin-bottom: 8px;\n}\n.index-module_tagContainer__3YNKY .index-module_upIcon__3F7Ui {\n  -webkit-transition: all 0.3s;\n  transition: all 0.3s;\n  line-height: 22px;\n  font-size: 12px;\n  display: block;\n}\n@media screen and (max-width: 900px) {\n  .index-module_tagContainer__3YNKY {\n    float: none;\n    max-width: 100%;\n    width: 100%;\n    margin: 16px 0;\n  }\n}\n.index-module_tagView__2Cg-A {\n  -webkit-box-flex: 1;\n          flex: 1;\n  display: -webkit-box;\n  display: flex;\n  flex-wrap: wrap;\n}\n.index-module_tagContainer__3YNKY.index-module_hasExpandButton__3RMDE {\n  text-align: left;\n}\n.index-module_expandButton__VE_y6 {\n  right: 0;\n  width: 54px;\n  display: -webkit-box;\n  display: flex;\n  line-height: 22px;\n  justify-content: space-around;\n  -webkit-box-align: center;\n          align-items: center;\n  height: 22px;\n}\n.index-module_expand__mSxSA {\n  overflow: hidden;\n  max-height: 30px;\n}\n.index-module_expand__mSxSA .index-module_upIcon__3F7Ui {\n  -webkit-transform: rotate(180deg);\n          transform: rotate(180deg);\n}\n.isMini .index-module_expandButton__VE_y6 {\n  font-size: 12px;\n  width: 42px;\n}\n.isMini .index-module_upIcon__3F7Ui {\n  -webkit-transform: scale(0.8);\n          transform: scale(0.8);\n}\n.isMini .index-module_expand__mSxSA .index-module_upIcon__3F7Ui {\n  -webkit-transform: rotate(180deg) scale(0.8);\n          transform: rotate(180deg) scale(0.8);\n}\n";
  var styles$1 = {"tagContainer":"index-module_tagContainer__3YNKY","upIcon":"index-module_upIcon__3F7Ui","tagView":"index-module_tagView__2Cg-A","hasExpandButton":"index-module_hasExpandButton__3RMDE","expandButton":"index-module_expandButton__VE_y6","expand":"index-module_expand__mSxSA"};
  styleInject(css$1);
  ...
  var getPathFromFilename = function getPathFromFilename(api, filenamePath) {
    var _ref2, data;

    return regeneratorRuntime.async(function getPathFromFilename$(_context) {
      while (1) {
  ...
  var onBeforeOpenModal = function onBeforeOpenModal(api, _ref3) {
    var item, type, onShowModal, position, targetPath, option;
    return regeneratorRuntime.async(function onBeforeOpenModal$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 10:
            ...
            _context2.next = 13;
            return regeneratorRuntime.awrap(getInsertPosition(api).catch(function (e) {
          ...
          case 13:
            ...
            _context2.next = 16;
            return regeneratorRuntime.awrap(getPathFromFilename(api, position.filename));
  ...
  var ToolTipAddButton = function ToolTipAddButton(_ref4) {
    var disabledTitle = _ref4.disabledTitle,
        disabled = _ref4.disabled,
        children = _ref4.children,
        reset = _objectWithoutProperties(_ref4, ["disabledTitle", "disabled", "children"]);
  ...
  var css$2 = ".GlobalSearch-module_search__2NS8S {\n  width: 266px;\n}\n.GlobalSearch-module_search__2NS8S > input {\n  background-color: #17171f;\n}\n.isMini .GlobalSearch-module_search__2NS8S > input {\n  height: 24px;\n}\n";
  var styles$2 = {"search":"GlobalSearch-module_search__2NS8S"};
  styleInject(css$2);
  ...
  var useCallData = function useCallData(getData, effects, options) {
    ...
    var fetchList = function fetchList(isAppend) {
      var _ref3, data, success, message, newList, totalCount;

      return regeneratorRuntime.async(function fetchList$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              setLoading(true);
  ...
  var RoutePathTree = function RoutePathTree(props) {
    ...
    var _useCallData = useCallData(function _callee() {
  ...
  var AddBlockFormForUI = function AddBlockFormForUI(_ref2) {
    ...
    return React__default.createElement(React__default.Fragment, null, React__default.createElement(antd.Form.Item, {
      ...
      rules: [{
        validator: function validator(rule, name) {
          ...
          return regeneratorRuntime.async(function validator$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 6:
                  _context.next = 8;
                  return regeneratorRuntime.awrap(getPathFromFilename(api, form.getFieldValue('path')));
  ...
  var getNoExitVar = function getNoExitVar(_ref) {
    var api, name, path, defaultName, _ref$index, index, _ref$need, need, _ref2, exists;

    return regeneratorRuntime.async(function getNoExitVar$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
  ...
  var getNoExitRoute = function getNoExitRoute(_ref3) {
    var api, path, defaultPath, _ref3$index, index, _ref3$need, need, _ref4, exists, fileArray, name, filePath;

    return regeneratorRuntime.async(function getNoExitRoute$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
  ...
  var getNoExitPath = function getNoExitPath(_ref5) {
    var api, path, defaultPath, _ref5$index, index, _ref5$need, need, _ref6, exists, fileArray, name, filePath;

    return regeneratorRuntime.async(function getNoExitPath$(_context3) {
      while (1) {
  ...
  var addBlock = function addBlock(api, params) {
    var _ref, _ref$data, info;
  ...
  var Adder = function Adder(props) {
    ...
    React.useEffect(function () {
      ...
      var resetInitialValues = function resetInitialValues() {
        var noExitVar, initialValues;
        return regeneratorRuntime.async(function resetInitialValues$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return regeneratorRuntime.awrap(getNoExitVar({
              ...
              case 2:
                ...
                _context2.next = 5;
                return regeneratorRuntime.awrap(getNoExitPath({
                  path: blockTarget || initPath,
                  api: api,
              ...
              case 5:
                ...
                _context2.next = 8;
                return regeneratorRuntime.awrap(getNoExitRoute({
      ...
      onOk: function onOk() {
        ...
        if (addStatus === 'log') {
          antd.Modal.confirm({
            ...
            onOk: function onOk() {
              return regeneratorRuntime.async(function onOk$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      _context3.next = 2;
                      return regeneratorRuntime.awrap(cancelAddBlockTask(api));
        ...
        setTaskLoading(true);
        setFromCheck(true);
        form.validateFields().then(function _callee(values) {
          var params;
            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  _context4.next = 7;
                  return regeneratorRuntime.awrap(getPathFromFilename(api, values.path));
  ...
  var clearCache = function clearCache(api) {
    var hide, _ref, data;

    return regeneratorRuntime.async(function clearCache$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
  ...
  var renderActiveResourceTag = function renderActiveResourceTag(_ref2) {
    var type = _ref2.type,
        _ref2$matchedResource = _ref2.matchedResources,
        matchedResources = _ref2$matchedResource === void 0 ? [] : _ref2$matchedResource,
        _ref2$current = _ref2.current,
        current = _ref2$current === void 0 ? {
      id: ''
    } : _ref2$current,
        setActiveResource = _ref2.setActiveResource;
